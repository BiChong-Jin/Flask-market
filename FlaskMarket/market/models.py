...
class User(db.Model):
    ...
    password_hash = db.Column(db.String(length=60), nullable=False)# a limitation of the length of the name.
    budget = db.Column(db.Integer(), nullable=False, default=1000)# a limitation of the length of the name.
